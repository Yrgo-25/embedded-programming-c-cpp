...
* Klasstemplates och icke-typ-templateparametrar.
...
* **G-uppgifter** – Grundläggande förståelse för interface, arv, stubbar och factory.
* **VG-uppgifter** – Templates, kompileringstidskontroller samt analys av flertrådad kod.
...
* All kod skrivs direkt i uppgiften (header-stil, metoder definieras i klassen).
