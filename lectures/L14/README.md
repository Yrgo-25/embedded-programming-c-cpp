...
I denna bilaga vidareutvecklar vi factory-exemplet från [föregående lektion](../L13/appendix/a_factory_raw_pointers.md).
...
Vi använder här en enklare form av Abstract Factory-mönstret.
